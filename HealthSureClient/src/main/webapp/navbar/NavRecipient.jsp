...
<link rel="stylesheet"
	href="/HealthSureClient/resources/css/navProvider.css" />
	...
	<div class="navbar-container">
		...
		<ul class="nav-links">
			...
			<li><a
				...
				class="nav-link">My Appointments</a></li>
			<li><a
				href="${pageContext.request.contextPath}/recipient/ShowInsurance.jsf"
				class="nav-link">My Insurance</a></li>
			<li><a
				href="${pageContext.request.contextPath}/recipient/SearchProviders.jsf"
				class="nav-link">Find Doctors</a></li>
			<li><a href="#" class="nav-link">Reports</a></li>
		</ul>

		<div class="profile-section">
			<a href="${pageContext.request.contextPath}/recipient/Profile.jsf"
				class="view-profile-btn"> <h:graphicImage library="media"
					name="images/defaultProfile.jpg" alt="Profile Avatar"
