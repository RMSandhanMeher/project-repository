...
public class InsuranceRetrivalException extends RuntimeException{
     ...
     */
	public InsuranceRetrivalException(String message) {
		super(message);
	}
     ...
     */
	public InsuranceRetrivalException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   The original, underlying technical cause.
	 */
	public InsuranceRetrivalException(String message, Throwable cause) {
		super(message, cause);
	}
